...
namespace BookStore.Migrations
{
    ...
    [Migration("20231023123651_Add CfPassword for User")]
    partial class AddCfPasswordforUser
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AddressUser", b =>
                {
                    b.HasOne("BookStore.Model.Address", null)
                        .WithMany()
                        .HasForeignKey("AddressesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BookStore.Model.User", null)
                        .WithMany()
